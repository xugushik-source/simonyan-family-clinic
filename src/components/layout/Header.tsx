  ...
  return (
    <header className="sticky top-0 z-40 border-b border-forest-100 bg-milk/95 backdrop-blur">
      <Container className="flex h-16 items-center justify-between gap-4 sm:h-20">
        <Link href="/" className="flex items-center gap-2 font-serif text-lg font-semibold text-forest-900 sm:text-xl">
          <span className="flex h-9 w-9 items-center justify-center rounded-full bg-forest-700 text-sm font-bold text-milk">
            SC
          </span>
        ...
        <div className="flex items-center gap-2 lg:hidden">
          ...
          <button
            type="button"
            onClick={() => setOpen((v) => !v)}
            className="flex h-10 w-10 items-center justify-center rounded-full border border-forest-200 text-forest-800"
            aria-label="Menu"
            aria-expanded={open}
          >
      ...
      {open && (
        <div className="border-t border-forest-100 bg-milk lg:hidden">
